...
export function GoogleMeetIcon({ className, style }: GoogleMeetIconProps) {
  return (

	<svg xmlns="http://www.w3.org/2000/svg" width="60.67" height="50" viewBox="0 0 256 211" className={className} style={style}>
