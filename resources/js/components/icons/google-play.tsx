...
export function GooglePlayIcon({ className, style }: GooglePlayIconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="45.23" height="50" viewBox="0 0 256 283" className={className} style={style}>
