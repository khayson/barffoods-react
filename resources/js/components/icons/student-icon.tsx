...
export function StudentIcon({ className, style }: StudentIconProps) {
  return (
<svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 256 256" className={className} style={style}>
