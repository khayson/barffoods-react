...
export function PeopleIcon({ className, style }: PeopleIconProps) {
  return (
	<svg xmlns="http://www.w3.org/2000/svg" width="46.88" height="50" viewBox="0 0 15 16" className={className} style={style}>
