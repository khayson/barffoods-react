...
export function CertificateIcon({ className, style }: CertificateIconProps) {
  return (    
	<svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 15 15" className={className} style={style}>
